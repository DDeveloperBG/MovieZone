        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListingImgName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DetailsImgName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieCategoriesId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MoviesId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieMoviesCategory", x => new { x.MovieCategoriesId, x.MoviesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MovieMoviesCategory_MoviesCategories_MovieCategoriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesCategories_IsDeleted",
