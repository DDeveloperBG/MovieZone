...
namespace MovieZone.Persistence.Migrations
{
    ...
    [Migration("20220511123840_AddedVideoChatConversationEntity")]
    partial class AddedVideoChatConversationEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserVideoChatConversation", b =>
                {
                    b.Property<string>("ParticipantsId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("VideoChatConversationsId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("ParticipantsId", "VideoChatConversationsId");

                    b.HasIndex("VideoChatConversationsId");

                    b.ToTable("ApplicationUserVideoChatConversation");
                });
            ...
            modelBuilder.Entity("MovieZone.Domain.Entities.VideoChatConversation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("VideoChatConversations");
                });
            ...
            modelBuilder.Entity("ApplicationUserVideoChatConversation", b =>
                {
                    ...
                    b.HasOne("MovieZone.Domain.Entities.VideoChatConversation", null)
                        .WithMany()
                        .HasForeignKey("VideoChatConversationsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
